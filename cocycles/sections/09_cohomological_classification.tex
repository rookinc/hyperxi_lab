...
\]
encodes vertex switching, corresponding to the standard notion of switching
equivalence in signed graphs \cite{zaslavsky}.
...
\begin{proof}
A regular $\mathbb{Z}_2$-cover of a connected graph is determined, up to
equivalence, by a $\mathbb{Z}_2$-valued $1$-cocycle recording whether
each base edge lifts sheet-preservingly or sheet-swappingly.

By construction, $\varepsilon(e)$ records exactly this dichotomy for the
cover $G_{30}\to G_{15}$. Hence $\varepsilon$ is the classifying cocycle
of the cover.
\end{proof}
...
the $\mathbb{Z}_2$-cover $G_{30}\to G_{15}$.
